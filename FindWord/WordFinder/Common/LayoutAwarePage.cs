...
namespace FindWord.Common
{
    ...
    public class LayoutAwarePage : Page
    {
        ...
        public LayoutAwarePage()
        {
            ...
            this.ItemsViewModel = new ObservableDictionary<String, Object>();
        ...
        /// </summary>
        protected IObservableMap<String, Object> ItemsViewModel
        {
            get
            {
        ...
        public void StartLayoutUpdates(object sender, RoutedEventArgs e)
        {
            if (BottomAppBar != null)
            {
                ...
                {
                    BottomAppBarOpened(null, null);
                }
                else
                {
                    BottomAppBarClosed(null, null);
                }
